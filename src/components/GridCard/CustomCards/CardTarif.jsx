        ...
        <Card colSpan={colSpan} position={position}>
            ...
            >
                <div className="relative top-0 left-4">
                    <img className="relative w-10 sm:w-14 mt-[-50%]" src="/SVG/money-euro-banknote-svgrepo-com.svg" alt=""
                        style={{
                    ...
                    />
                    <img className="absolute w-10 sm:w-14 mt-[-50%]" src="/SVG/money-euro-banknote-svgrepo-com.svg" alt=""
                        style={{
                ...
                <div className="flex flex-col justify-end items-end">
                    {tarifYear && <div>
                        <span className="text-2xl sm:text-6xl font-bold">{tarifYear}K€</span>
                        <span className="text-sm">/an</span>
                    </div>}
                    {tarifDay && <div>
                        <span className="text-2xl sm:text-6xl font-bold">{tarifDay}€</span>
                        <span className="text-sm">/jour</span>
                    </div>}
                    {tarifHour && <div>
                        <span className="text-2xl sm:text-6xl font-bold">{tarifHour}€</span>
