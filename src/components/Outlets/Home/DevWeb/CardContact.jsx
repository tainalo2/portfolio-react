...
const CardContact = ({ colSpan, position }) => {
    ...
    useEffect(() => {
        async function sequence() {
            while (true) {
                await controls1.start({ y: 10, opacity: 1, transition: { delay: 3, duration: 1, ease: "easeInOut" } });
                await controls1.start({ y: 0, opacity: 0.7, transition: { delay: 1, duration: 1, ease: "easeInOut" } });
                await controls2.start({ y: 10, opacity: 1, transition: { delay: 3, duration: 1, ease: "easeInOut" } });
                await controls2.start({ y: 0, opacity: 0.7, transition: { delay: 1, duration: 1, ease: "easeInOut" } });
                await controls3.start({ y: 10, opacity: 1, transition: { delay: 3, duration: 1, ease: "easeInOut" } });
